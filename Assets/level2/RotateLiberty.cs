...
public class RotateLiberty : MonoBehaviour
{
    ...
    IEnumerator timer()
    {
        ...
        if (counter % 2==0)
        {
            ...
            {
              if (  (gobj.transform.localRotation != Quaternion.Euler((float)-90.5, (float)25.3, 90))
                ) { 
                gobj.transform.localRotation = Quaternion.Euler((float)-90.5, (float)y, 90);
